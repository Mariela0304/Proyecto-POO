...
public class ControllerSubasta extends Controller {
    ...
    public boolean registrarSubastas(LocalDate fechaVencimiento,
        ...
        LocalTime tiempoVencimiento = LocalTime.now();
        LocalDateTime fechaVencimientoFinal = LocalDateTime.of(fechaVencimiento, tiempoVencimiento);
        ...
        try {
             ...
             registrado = dao.registrarSubasta(fechaVencimientoFinal, precioMinimo, items, cantidad_items, login.getIdentificacion());
    ...
    public boolean registrarSubastas(LocalDate fechaVencimiento,
        ...
        try {
            ...
            registrado = dao.registrarSubasta(fechaVencimientoFinal, precioMinimo, items, cantidad_items, numVendedor, coleccionista);
