...
public class InfoSubastaControllerColeccionista implements Initializable {
    ...
    @FXML
    JFXButton btn_ir_ofertar;
    @FXML
    JFXButton btn_ver_items;
    @FXML
    JFXButton btn_calificar_vendedor;

    @FXML
    TableColumn<Oferta, String> columnOferta;
    @FXML
    TableColumn<Oferta, String> columnOferente;
    @FXML
    ...
    /**
     * Permite realizar el conteo de las horas, minutos y segundos que faltan
     */
